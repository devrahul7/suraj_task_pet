...
function buildTemplate(context: TemplateContext): EmailTemplateContent {
...
export const EmailTemplates = {
  booking(name: string, details: string, actionUrl?: string) {
  ...
  approval(name: string, details: string, actionUrl?: string) {
    return buildTemplate({
      name,
  ...
  cancellation(name: string, details: string, actionUrl?: string) {
    return buildTemplate({
      name,
  ...
  completion(name: string, details: string, actionUrl?: string) {
    return buildTemplate({
      name,
  ...
  resetPassword(name: string, actionUrl: string) {
    return buildTemplate({
      name,
